...
productArray = [
  {name: 'Desportivo das Aves', description: 'Official Portuguese league football jersey.', colour: "red", price: 3999, image: aves},
  {name: 'Belenenses SAD', description: 'Official Portuguese league football jersey.', colour: "blue", price: 3999, image: belem},
  {name: 'Desportivo de Chaves', description: 'Official Portuguese league football jersey.', colour: "red", price: 3999, image: chaves},
  {name: 'Moreirense', description: 'Official Portuguese league football jersey.', colour: "green", price: 3999},
  {name: 'Feirense', description: 'Official Portuguese league football jersey.', colour: "blue", price: 3999, image: feirense},
  {name: 'Vitoria de Guimaraes', description: 'Official Portuguese league football jersey.', colour: "white", price: 3999, image: guimaraes},
  {name: 'Maritimo', description: 'Official Portuguese league football jersey.', colour: "red", price: 3999, image: maritimo},
  {name: 'Portimonense', description: 'Official Portuguese league football jersey.', colour: "black", price: 3999, image: portimonense},
  {name: 'Rio Ave', description: 'Official Portuguese league football jersey.', colour: "green", price: 3999, image: rioave},
  {name: 'Vitoria de Setubal', description: 'Official Portuguese league football jersey.', colour: "green", price: 3999, image: setubal},
  {name: 'Tondela', description: 'Official Portuguese league football jersey.', colour: "yellow", price: 3999, image: tondela},
  {name: 'Boavista Futebol Clube', description: 'Official Portuguese league football jersey.', colour: "black", price: 4999, image: boavista},
  {name: 'Sporting Clube de Braga', description: 'Official Portuguese league football jersey.', colour: "red", price: 4999, image: braga},
  {name: 'Sport Lisboa e Benfica', description: 'Official Portuguese league football jersey.', colour: "red", price: 4999, image: benfica},
  {name: 'Futebol Clube do Porto', description: 'Official Portuguese league football jersey.', colour: "blue", price: 4999, image: porto},
  {name: 'Sporting Clube de Portugal', description: 'Official Portuguese league football jersey.', colour: "green", price: 4999, image: sporting},
]
